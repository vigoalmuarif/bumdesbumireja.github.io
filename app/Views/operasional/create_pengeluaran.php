...
<form action="<?= base_url('operasional/save') ?>" method="post" id="save">
    <div class="modal fade" id="addPengeluaran" tabindex="-1" aria-labelledby="addPengeluaranLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addPengeluaranLabel">Tambah Pengeluaran</h5>
