<!-- Modal -->
<form action="<?= base_url('operasional/update_pemasukan') ?>" method="post" id="edit">
    <div class="modal fade" id="editPemasukan" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="editPemasukanLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editPemasukanLabel">Ubah Pemasukan</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mx-auto">
                            <input type="hidden" name="id" id="id" value="<?= $pemasukan['id'] ?>">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control font-weight-bold" name="jumlah" id="jumlah" autocomplete="off" value="<?= $pemasukan['jumlah'] ?>">
                            ...
                            <div class="form-group ">
                                ...
                                <select class="custom-select" id="jenis" name="jenis" aria-describedby="jenisFeedback">
                                    ...
                                    <option value="Umum" <?= $pemasukan['unit'] == "Umum" ? "selected='selected'" : '' ?>>Umum</option>
                                    <option value="Pasar" <?= $pemasukan['unit'] == "Pasar" ? "selected='selected'" : '' ?>>Pasar</option>
                                    <option value="ATK" <?= $pemasukan['unit'] == "ATK" ? "selected='selected'" : '' ?>>ATK</option>
                                </select>
...
<script>
    $(document).ready(function() {
        ...
        let date = "<?= date('Y-m-d', strtotime($pemasukan['date'])) ?>";
