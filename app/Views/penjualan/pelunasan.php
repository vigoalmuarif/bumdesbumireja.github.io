...
<form action="<?= base_url('penjualan/save_bayar_piutang') ?>" method="post" id="formPembayaran">
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalBayarPiutangLabel">Pembayaran Piutang</h5>
                    ...
                    <div class="row">
                        <div class="col">
                            <table class="table table-borderless table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Sisa Piutang</td>
                                        <td>:</td>
                                        <td>Rp. <?= number_format($detail['total'] - $detail['bayar'], 0, ",", ","); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr>
                            <div class="form-group">
                                <input type="hidden" name="penjualan" id="penjualan" value="<?= $detail['penjualan_id'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg font-weight-bold kurleb text-danger" id="kurleb" value="<?= $detail['total'] - $detail['bayar'] ?>" readonly name="kurleb">
                            </div>
                        </div>
                    </div>
                </div>
