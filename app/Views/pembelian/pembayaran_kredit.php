        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalPembayaranTunaiLabel">Pembayaran (Kredit)</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-lg font-weight-bold" value="0" onclick="this.select();" name="bayar" id="bayar" autocomplete="off">
