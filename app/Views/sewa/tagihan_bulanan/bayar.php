...
<a href="<?= base_url('periode/tagihanBulanan') ?>" class="btn btn-primary btn-sm mb-4">Kembali</a>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="<?= base_url('pembayaran/prosesBayarTagihanBulanan/' . $get['tagihanBulanan_id']) ?>" method="post">
                            ...
                            <button type="submit" class="btn btn-primary float-right" <?= $get['bulanan_status'] == 1 ? 'disabled' : '' ?>>Bayar</button>
                        </form>
                    </div>
                </div>
            </div>
