    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalPembayaranLabel">Pembayaran Sewa</h5>
            ...
            <form action="<?= base_url('persewaan/simpan_pembayaran') ?>" method="post" id="formPembayaran" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-lg font-weight-bold" name="bayar" value="<?= $harga ?>" onfocus="(this).select();" id="bayar" autocomplete="off">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const metode_bayar = $("#metodePembayaran").val();
